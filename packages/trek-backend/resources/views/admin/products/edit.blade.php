    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.update", [$product->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('product_brand_id') ? 'is-invalid' : '' }}" name="product_brand_id" id="product_brand_id" required>
                    @foreach($productBrands as $id => $productBrand)
                        <option value="{{ $id }}" {{ (old('product_brand_id') ? old('product_brand_id') : $product->product_brand_id ?? '') == $id ? 'selected' : '' }}>{{ $productBrand }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('product_model_id') ? 'is-invalid' : '' }}" name="product_model_id" id="product_model_id" required>
                    @foreach($productModels as $id => $productModel)
                        <option value="{{ $id }}" {{ (old('product_model_id') ? old('product_model_id') : $product->product_model_id ?? '') == $id ? 'selected' : '' }}>{{ $productModel }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('product_version_id') ? 'is-invalid' : '' }}" name="product_version_id" id="product_version_id" required>
                    @foreach($productVersions as $id => $productVersion)
                        <option value="{{ $id }}" {{ (old('product_version_id') ? old('product_version_id') : $product->product_version_id ?? '') == $id ? 'selected' : '' }}>{{ $productVersion }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('product_category_code_id') ? 'is-invalid' : '' }}" name="product_category_code_id" id="product_category_code_id" required>
                    @foreach($productCategoryCodes as $id => $productCategoryCode)
                        <option value="{{ $id }}" {{ (old('product_category_code_id') ? old('product_category_code_id') : $product->product_category_code_id ?? '') == $id ? 'selected' : '' }}>{{ $productCategoryCode }}</option>
                    @endforeach
                </select>
