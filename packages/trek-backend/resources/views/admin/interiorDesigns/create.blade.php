...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.interiorDesign.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.interior-designs.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('bum_id') ? 'is-invalid' : '' }}"
                    ...
                    @foreach($bums as $id => $bum)
                        <option value="{{ $id }}" {{ old('bum_id') == $id ? 'selected' : '' }}>{{ $bum }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('sales_id') ? 'is-invalid' : '' }}"
                    ...
                    @foreach($saleses as $id => $sales)
                        <option value="{{ $id }}" {{ old('sales_id') == $id ? 'selected' : '' }}>{{ $sales }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('religion_id') ? 'is-invalid' : '' }}"
                    ...
                    @foreach($religions as $id => $religion)
                        <option value="{{ $id }}" {{ old('religion_id') == $id ? 'selected' : '' }}>{{ $religion }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bank_account_holder') ? 'is-invalid' : '' }}" type="text" name="bank_account_holder" id="bank_account_holder" value="{{ old('bank_account_holder', '') }}">
