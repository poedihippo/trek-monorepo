            ...
            <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Report">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.report.fields.reportable_label') }}
                        </th>
                        <th>
                            {{ trans('cruds.report.fields.start_date') }}
                        </th>
                        <th>
                            {{ trans('cruds.report.fields.end_date') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                    ...
                    <tr>
                        ...
                        <x-filter-enum base-enum="{{ \App\Enums\ReportableType::class }}"></x-filter-enum>
                        <td>
                            <input class="search" type="text" placeholder="{{ trans('global.search') }}">
                        </td>
                        <td>
        ...
        $(function() {
            ...
            let dtOverrideGlobals = {
                ...
                columns: [{
                    ...
                    {
                        data: 'reportable_label',
                        name: 'reportable_label'
                    },
                    {
                        data: 'start_date',
                        name: 'start_date'
