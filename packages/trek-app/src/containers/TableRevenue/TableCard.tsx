...
export default ({ activityData, isDeals, onPress }: PropTypes) => {
  ...
  return (
    ...
    >
      <Div py={14} row style={{ backgroundColor: "white" }}>
        <Div flex={3}>
          <Text color="black" fontWeight="normal" textAlign="center">
            {activityData.order.invoiceNumber}
          </Text>
        </Div>
        <Div flex={4}>
          <Text color="black" fontWeight="normal" textAlign="center">
